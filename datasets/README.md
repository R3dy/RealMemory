...
|--------|-------|
| Total examples | 370 |
| Single-turn conversations | 360 |
| Multi-turn conversations | 10 |
| Estimated total tokens | ~425K |
| Average tokens per example | ~1,148 |
| File size | ~1.7 MB |
...
### RealMemory Deep-Dive Expansion (76 examples)
...
All part files are merged into the final `agentic-workflow-lora-training.jsonl` (370 examples total).
