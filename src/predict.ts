 ...
 *
 * - A prediction of failure (willSucceed:false) at confidence 0.8 that
 *   actually fails: expected = 1 - 0.8 = 0.2; actual = 0; surprise = 0.2.
 * - A prediction of success (willSucceed:true) at confidence 0.5 that
 *   actually fails: expected = 0.5; actual = 0; surprise = 0.5.
 * - A prediction of success at confidence 0.5 that succeeds: surprise = 0.5.
 * - A user correction forces surprise = 1.0 (maximal) — see plugin.ts.
 */
