...
__export(index_exports, {
  ...
  InvalidConfidenceError: () => InvalidConfidenceError,
  ...
  SelfRelationshipError: () => SelfRelationshipError,
  VERSION: () => VERSION,
  classifyIntent: () => classifyIntent,
  computeFrequencyFactor: () => computeFrequencyFactor,
  computeRecencyFactor: () => computeRecencyFactor,
  ...
  embeddingFromBuffer: () => embeddingFromBuffer,
  embeddingToBuffer: () => embeddingToBuffer,
  evaluateDelta: () => evaluateDelta,
